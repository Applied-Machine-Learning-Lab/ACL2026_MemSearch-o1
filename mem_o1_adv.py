...
from bge import retrieve, route
...
def main():
    ...
    if worker == 'line2':
        API_SECRET_KEY = "sk-zk235b565500953e9c3532c975ee140f8a268c5287f2b792"
        BASE_URL = "https://api.zhizengzeng.com/v1"
    if worker == 'line3':
        API_SECRET_KEY = "sk-zk260312b5be4581b79bb9daeafd8c85d0368cc437766372"
        BASE_URL = "https://api.zhizengzeng.com/v1"
    ...
    out_path = f"longbench/mem_bge_route_mquery/ablation/{model_name}/{dataset_name}"
    ...
    for sequences_needing_generation in tqdm(sequences_list, desc = "Executing Search o1..."):
        ...
        while True:
            ...
            # if batch_sequences:
            #     print(f"Batch processing {len(batch_sequences)} sequences with generate_docs_to_reasonchain_batch...")
            #     docs_analyses, records = generate_docs_to_reasonchain_batch(
